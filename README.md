...
<p align="center">
  <img src="https://skillicons.dev/icons?i=html,css,js,bootstrap,php,mysql,wordpress,git,github,vscode" />
</p>
...
| ---------------- | ----------------------- | --------------- |
| 🔥 Wiki App      | Dynamic content loading | JS + AJAX       |
| 🎧 Spotify Clone | Music player UI         | HTML + CSS + JS |
| 📅 Event System  | Full stack system       | PHP + MySQL     |
